...
rem renderer dll
clang src\renderer\vulkan\win32_vulkan.c %compiler_flags% -std=c17 %includes% -I%VULKAN_SDK%\Include %defines% %includes% -shared -o bin\vulkan_renderer.dll

exit

:comment
cmake -S . -B build -Tv143
cmake --build build